          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, vendor_type: value as VendorType })
                }
              >
                <SelectTrigger>
                  <SelectValue />
                ...
                <SelectContent>
                  {Object.entries(VENDOR_TYPES).map(
                    ([key, { label, icon }]) => (
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({
                      ...formData,
                      work_frequency: value as PaymentFrequency,
                    })
                  }
                >
                  <SelectTrigger>
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    preferred_vendor: e.target.checked,
                  })
                }
                className="rounded"
              />
