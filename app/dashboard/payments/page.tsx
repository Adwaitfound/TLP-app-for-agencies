...
import { Plus, Wallet, Users, TrendingUp, Clock, IndianRupee, Download } from "lucide-react"
...
import type { Vendor, VendorPayment, VendorProjectAssignment, ServiceType } from "@/types"
...
export default function PaymentsPage() {
    ...
    const [filterVertical, setFilterVertical] = useState<ServiceType | 'all'>('all')
    ...
    async function loadData() {
        setPageLoading(true)
        try {
            const [vendorsRes, paymentsRes, analyticsRes, assignmentsRes] = await Promise.all([
                fetchVendors(),
                fetchPayments(),
                fetchVendorAnalytics(),
                fetchVendorAssignments(),
            ...
            <div className="space-y-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Only admins can view Payments & Vendors.</CardDescription>
                    </CardHeader>
                    <CardContent>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between gap-3">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Payments & Vendors</h1>
                    <p className="text-muted-foreground">
                        Track vendor payments, budgets, and project expenses across all verticals
                    </p>
                </div>
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    <Button className="w-full sm:w-auto" variant="outline" onClick={() => setShowAddVendor(true)}>
                        <Plus className="mr-2 h-4 w-4" />
                        Add Vendor
                    </Button>
                    <Button className="w-full sm:w-auto" onClick={() => setShowAddPayment(true)}>
                ...
                <TabsContent value="overview" className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>View payments and vendors by service type</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="flex flex-wrap gap-2">
                                ...
                                {Object.values(SERVICE_TYPES).map(service => (
                                    <Button
                                        key={service.value}
                                        variant={filterVertical === service.value ? 'default' : 'outline'}
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Latest vendor payments across all projects</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <PaymentList
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Vendors with highest total payments</CardDescription>
                        </CardHeader>
                        <CardContent>
                                    ...
                                    .map(vendor => (
                                        <div key={vendor.id} className="flex items-center justify-between">
                                            ...
                                            <div className="text-right">
                                                <p className="font-semibold">{formatCurrency(vendor.total_amount_paid)}</p>
