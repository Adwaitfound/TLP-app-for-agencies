...
import {
  ...
  deleteInvoice,
  getSignedInvoiceUrl,
  updateInvoiceSharedStatus,
} from "@/app/actions/invoice-operations";
                  ...
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell>
                      <Select
                        ...
                        onValueChange={(newStatus) =>
                          updateInvoiceStatus(invoice.id, newStatus).then(
                            (result) => {
                              if (result.error) {
                    ...
                    <TableCell>
                      <input
                        ...
                        onChange={(e) =>
                          updateInvoiceSharedStatus(invoice.id, e.target.checked).then(
                            (result) => {
                              if (result.error) {
                                showToast(result.error, "error");
                              } else if (result.data) {
