...
export default function ClientSettingsPage() {
  ...
  useEffect(() => {
    if (user) {
      debug.log("CLIENT_SETTINGS", "Loading user data", { userId: user.id });
      setProfileData({
  ...
  async function handleSaveProfile() {
    ...
    setSaving(true);
    debug.log("CLIENT_SETTINGS", "Saving profile", { userId: user.id });
    ...
    try {
      ...
      debug.success("CLIENT_SETTINGS", "Profile saved");
      if (updatedProfile) {
      ...
      debug.error("CLIENT_SETTINGS", "Save profile error", {
  ...
  async function handleChangePassword(e: React.FormEvent) {
    ...
    try {
      ...
      debug.success("CLIENT_SETTINGS", "Password changed");
      setSavedMessage("Password updated successfully!");
      setPasswordData({ current: "", new: "", confirm: "" });
      setTimeout(() => setSavedMessage(""), 3000);
    } catch (error: any) {
      debug.error("CLIENT_SETTINGS", "Change password error", {
        message: error.message,
      });
