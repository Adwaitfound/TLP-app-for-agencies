...
export async function updatePayment(id: string, updates: Partial<VendorPayment>) {
    const supabase = await createClient()
...
export async function createAssignment(assignment: Partial<VendorProjectAssignment>) {
    const supabase = await createClient()
...
export async function updateAssignment(id: string, updates: Partial<VendorProjectAssignment>) {
    const supabase = await createClient()
