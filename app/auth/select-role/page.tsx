  ...
  const roles = [
    {
      ...
      title: "Client",
      description:
        "Access your projects, view progress, and communicate with your team",
      icon: Users,
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {roles.map((role) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${role.color} opacity-0 group-hover:opacity-5 transition-opacity`}
                />
